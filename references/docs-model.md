...
- current blocker
- next step
- links to `meta.yaml`、`plan.md`、`progress.md`
...
- `当前主线` 只写当前这一轮正在推进什么；不要写完整方案、详细实现、验收数据或历史结论
- `下一步` 只写马上要推进的 1-3 个动作；普通待办、远期待办和已完成明细下沉到 `plan.md` 或 `progress.md`
